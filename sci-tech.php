	...
	<div id="centerSection">
		<div id="post">
			<ul>
				...
				<li><h1>Sci-Tech</h1><video width="500" height="auto" controls>
				<source src="https://img-9gag-fun.9cache.com/photo/a47Ag16_460sv.mp4" type="video/mp4">
				</video></li><strong>Ruler Camera</strong>
				...
				<source src="https://img-9gag-fun.9cache.com/photo/aeb40MO_460sv.mp4" type="video/mp4">
				</video></li><strong> Cardboard Robotic Arm</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br>
				
				<li><video width="500" height="auto" controls>
				<source src="https://img-9gag-fun.9cache.com/photo/aN126bw_460svvp9.webm" type="video/mp4">
				</video></li><strong> LED Wavelenght Change With Liquid Nitrogen</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br>
				
				<li>
				<img src="https://img-9gag-fun.9cache.com/photo/aKjXWRO_460swp.webp" width="500" height="420">
				</li><strong> Worlds Tiniest Computer & a Rice</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br><br>
				
				<li>
				<img src="https://img-9gag-fun.9cache.com/photo/anj19G0_460swp.webp" width="500" height="530">
				</li><strong> Java Is The Floor </strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br><br>
