	...
	<div id="centerSection">
		<div id="post">
			<ul>
				...
				<li><h1>Sports</h1><video width="500" height="auto" controls>
				<source src="https://img-9gag-fun.9cache.com/photo/aBx0xLP_460sv.mp4" type="video/mp4">
				</video></li><strong>Awesome Slam Dunk</strong>
				...
				<source src="https://img-9gag-fun.9cache.com/photo/ayXmvPM_460svvp9.webm" type="video/mp4">
				</video></li><strong> Coolest Ball Steal</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br>
				
				<li><video width="500" height="auto" controls>
				<source src="https://img-9gag-fun.9cache.com/photo/aDxqvpK_460svvp9.webm" type="video/mp4">
				</video></li><strong> Like a Weapon Bullet</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br><br><br>
				
				<li>
				<img src="https://img-9gag-fun.9cache.com/photo/a47m8ov_460swp.webp" width="500" height="500">
				</li><strong> Big Shaq & Bill Gates</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br><br>
				
				<li><video width="500" height="auto" controls>
				<source src="https://img-9gag-fun.9cache.com/photo/a9pwZQK_460svvp9.webm" type="video/mp4">
				</video></li><strong> Karma..</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br>
