	...
	<div id="centerSection">
		<div id="post">
			<ul>
				...
				<li><h1>Nature</h1><video width="500" height="auto" controls>
				<source src="https://img-9gag-fun.9cache.com/photo/avO50dq_460sv.mp4" type="video/mp4">
				</video></li><strong>Beautiful Switzerland</strong>
				...
				<source src="https://img-9gag-fun.9cache.com/photo/aq7B3DM_460svvp9.webm" type="video/mp4">
				</video></li><strong> Nature Is Awesome</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br>
				
				<li>
				<img src="https://img-9gag-fun.9cache.com/photo/azX9mWq_460swp.webp" width="500" height="420">
				</li><strong> "Sakura" Trees in Japan</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br><br>
				
				<li>
				<img src="https://img-9gag-fun.9cache.com/photo/aKDBX2W_460swp.webp" width="500" height="420">
				</li><strong> Crystal Clear Lakes</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br><br>
				
				<li>
				<img src="https://img-9gag-fun.9cache.com/photo/aYgvOAw_460swp.webp" width="500" height="530">
