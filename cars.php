	...
	<div id="centerSection">
		<div id="post">
			<ul>
				...
				<li><h1>Cars</h1><video width="500" height="auto" controls>
				<source src="https://img-9gag-fun.9cache.com/photo/aNAZKg6_460sv.mp4" type="video/mp4">
				</video></li><strong>Fliping Carting</strong>
				...
				<source src="https://img-9gag-fun.9cache.com/photo/amrWrdV_460sv.mp4" type="video/mp4">
				</video></li><strong> Insanely Fast</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br>
				
				<li><video width="500" height="auto" controls>
				<source src="https://img-9gag-fun.9cache.com/photo/aDxqL8O_460svvp9.webm" type="video/mp4">
				</video></li><strong> Super Car</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br>
				
				<li>
				<img src="https://img-9gag-fun.9cache.com/photo/aDxqNLG_460swp.webp" width="500" height="500">
				</li><strong> Coolest Car</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br><br>
				
				<li>
				<img src="https://img-9gag-fun.9cache.com/photo/abMLROb_460swp.webp" width="500" height="320">
				</li><strong> Engineering Beauty</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br><br>
