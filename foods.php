	...
	<div id="centerSection">
		<div id="post">
			<ul>
				...
				<li><h1>Foods & Drinks</h1><video width="500" height="auto" controls>
				<source src="https://img-9gag-fun.9cache.com/photo/aR3V1rM_460sv.mp4" type="video/mp4">
				</video></li><strong>Salmon Poke Bowl.. Delicious!!</strong>
				...
				<source src="https://img-9gag-fun.9cache.com/photo/ajE3jq1_460svvp9.webm" type="video/mp4">
				</video></li><strong> Honey Garlic Shrimp.. Sweet!!</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br>
				
				<li><video width="500" height="auto" controls>
				<source src="https://img-9gag-fun.9cache.com/photo/aAxLQ7o_460svvp9.webm" type="video/mp4">
				</video></li><strong> Com Bacon Hamburger</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br>
				
				<li>
				<img src="https://img-9gag-fun.9cache.com/photo/a3KzD4N_460swp.webp" width="500" height="420">
				</li><strong> Delicious Salmon</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br><br>
				
				<li>
				<img src="https://img-9gag-fun.9cache.com/photo/aBxbXYP_460swp.webp" width="500" height="530">
				</li><strong> Epic English Breakfast</strong>
				<p><button id="upVote" type="button"><img src="images/upVote.png"></button> <button id="downVote" type="button"><img src="images/downVote.png"></button>
				<button id="comment" type="button"><strong>Comment</strong></button></p><br><br>
